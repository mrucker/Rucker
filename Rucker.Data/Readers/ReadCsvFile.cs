...
{
    public class ReadCsvFile : Disposable, IRead<IRows>
    {
        #region Fields
        ...
        public ReadCsvFile(string path): this()
        {
        ...
        public ReadCsvFile(Stream stream): this()
        {
        ...
        public IRows Read(int skip, int take)
        {
            ...
            AccountForHeaderRow(ref skip, ref take);
        ...
        private static void AccountForHeaderRow(ref int skip, ref int take)
        {
            skip++;
        }
