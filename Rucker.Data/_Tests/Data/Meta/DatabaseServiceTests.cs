...
namespace Rucker.Tests
{
    ...
    public class DatabaseServiceTests
    {
        ...
        {
            public TestTable() : base("(Id int identity, Bills int NOT NULL, Cents decimal(2,2) null, Notes varchar(1000) null, Bools bit null, InsertDate datetime null, UpdateDate datetime2 NOT NULL)")
            { }
        }
        #endregion
