...
namespace Data.Sql.Tests
{
    ...
    public class WritBulkTests
    {
        ...
        {
            public AlphabetTable(params object[] objects): base("(Id INT NOT NULL IDENTITY PRIMARY KEY, A CHAR, B CHAR NOT NULL, C CHAR)", new SqlQuerierConnection(Test.ConnectionString), objects)
            { }
        }
        #endregion
